...
if __name__ == "__main__":
    ...
    #amplerate_wm, data_wm = np.where(data_wm < np.mean(data_wm),0, 1)  # watermark进行(归一化的)二值化
    ...
    # 5.提取水印
    samplerate_syn, data_syn = wavfile.read("result.wav")
    ...
    wavfile.write("flag_ext.wav", samplerate_wm, data)
    draw_time("flag.wav", "flag")
    draw_time("flag_ext.wav", "flag_ext")
